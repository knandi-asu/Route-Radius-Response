...
var usePlacesAutocomplete = function usePlacesAutocomplete2(_temp) {
  ...
  var _useState2 = (0, import_react.useState)(defaultValue), value = _useState2[0], setVal = _useState2[1];
  var _useState3 = (0, import_react.useState)({
    loading: false,
    status: "",
    data: []
  }), suggestions = _useState3[0], setSuggestions = _useState3[1];
  var asRef = (0, import_react.useRef)();
  ...
  var clearSuggestions = (0, import_react.useCallback)(function() {
    setSuggestions({
      loading: false,
      status: "",
      data: []
  ...
  var clearCache = (0, import_react.useCallback)(function(key) {
    if (key === void 0) {
      key = cacheKey;
    }
    try {
  ...
  var fetchPredictions = (0, import_react.useCallback)(_debounce(function(val) {
    var _asRef$current;
    if (!val) {
      clearSuggestions();
      return;
  ...
  var setValue = (0, import_react.useCallback)(function(val, shouldFetchData) {
...
var getGeocode = function getGeocode2(args) {
...
var getLatLng = function getLatLng2(result) {
...
var getZipCode = function getZipCode2(result, useShortName) {
...
var getDetails = function getDetails2(args) {
...
export {
  usePlacesAutocomplete as default,
  getDetails,
  getGeocode,
  getLatLng,
  getZipCode
};
//# sourceMappingURL=use-places-autocomplete.js.map
